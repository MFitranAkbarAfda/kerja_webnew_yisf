                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-6 mr-auto align-self-center">
...

                                {
                                    ...
                                    <h2><b>IYSA FESTIVAL 2021, Has Been Successfully Carried Out!! </b></h2>

                                {
                                    /* <!-- About Description --> */
                                }

                                    <p className="desc"><b>Indonesian Young Scientist Association (IYSA)</b> cooperated between BUCA IMSEF, Turkey, Malaysia Innovation Invention Creativity Association (MIICA), The Union of Arab Academics, Departemen Aktuaria Institut Teknologi Sepuluh Nopember, and Science Hunter Indonesia already hold the IYSA Festival 2021.
                                    <br/><br/>
                                    ...
                                    <ol>
                                        <li>Gold medals, silver medals, bronze medals from IYSA</li>
                                        <li>Honourable Mention for OSPC dan YNSF</li>
                                        <li>MIICA Special Award</li>
                                        <li>BUCA IMSEF Special Award</li>
                                        <li>IYSA Special Award</li>
                                        <li>IYSA Semi Grand Award</li>
                                        <li>IYSA Grand Award</li>
                                    </ol>
                                    <br/><br/>
                                    So, congratulations for all winners, you’re doing a good job! You can check list of the winner of IYSA Festival 2021 at 
                                    www.yisf.or.id and www.ynsf.or.id
                                    <br/><br/>
                                    <b>See you in IYSA Festival 2022, keep active, creative, and innovative !</b>
